      ...
      <form onSubmit={onSubmitHandler}>
        <div className="space-y-4">
          ...
          <input
            ...
            className="block text-sm py-3 px-4 rounded-lg w-full border outline-none focus:ring focus:outline-none focus:ring-red-700"
            onChange={(event) => {
        ...
        <div className="text-center mt-6">
          <button
            type="submit"
            className="py-3 w-64 text-xl text-white bg-red-400 rounded-2xl hover:bg-red-300 active:bg-yellow-500 outline-none"
          >
            Sign In
          </button>
